...
Short records of the non-obvious decisions in Toychain and the trade-offs behind
them. Each record is self-contained: Context, Decision, Consequences.

- [0001 — Canonical binary serialization with domain separation](0001-canonical-serialization.md)
- [0002 — Account model instead of UTXO](0002-account-model.md)
